...
aruco_uwpMain::aruco_uwpMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void aruco_uwpMain::CreateWindowSizeDependentResources() 
{
