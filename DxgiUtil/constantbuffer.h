...
namespace dxgiutil {
	...
	public:
		bool Initialize(const Microsoft::WRL::ComPtr<ID3D11Device> &pDevice
			, SHADERSTAGE stage
			, const Microsoft::WRL::ComPtr<ID3D11ShaderReflection> &pReflector);

		void UpdateCB(const Microsoft::WRL::ComPtr<ID3D11DeviceContext> &pDeviceContext);
		void SetCB(const Microsoft::WRL::ComPtr<ID3D11DeviceContext> &pDeviceContext);
		...
		void SetSRV(const Microsoft::WRL::ComPtr<ID3D11DeviceContext> &pDeviceContext
		...
		void SetSampler(const Microsoft::WRL::ComPtr<ID3D11DeviceContext> &pDeviceContext
			, const ShaderResourceSlot &slot
